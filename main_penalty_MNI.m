...
for i_p = 1:length(Penalty_coef)
    ...
    %ROI结构图示
    showROI(LF.gray_matter,path4saveLF,1234,[5678 666 888]);% showROI(gray_matter,savepath,ROI_label,TakeOut_label) 如果不想看惩罚区域，可以把惩罚区域置[]
