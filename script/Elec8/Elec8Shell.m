function [T,U] = Elec8Shell(Nr,ER0P,areaRP,Nc,EC0P,areaCP,method_ROI,method_Cortex,cu,C,U,thres,Rthres,kMax)
%MODIFY4S Summary of this function goes here
%   Detailed explanation goes here
FC = Elec8Wrapper(Nc,EC0P,areaCP,method_Cortex,cu,C,U);
FR = Elec8Wrapper(Nr,ER0P,areaRP,method_ROI,cu,C,U);
FR(FR<thres) = 0;
FP = FR./FC;
FP(FP<=Rthres) = 0;
idx0 = find(FP);
