function elec_circle(Pos,Label,r,edgecolor,facecolor,linewidth,linestyle,FontSize)
...
rectangle('position',[Pos(i,1)-r,Pos(i,2)-r,r*2,r*2],'curvature',[1,1],...
    'edgecolor',edgecolor,'facecolor',thefacecolor,'LineWidth',linewidth,'LineStyle',linestyle);
if ~isempty(Label)
